...
class BASNet(nn.Module):
    ...
    def forward(self,x):
        ...
        hx = self.encoder1(hx) # 256
        h1 = hx
        print(h1.shape)
        hx = self.encoder2(hx) # 128
        h2 = hx
        print(h2.shape)
        hx = self.encoder3(hx) # 64
        h3 = hx
        print(h3.shape)
        hx = self.encoder4(hx) # 32
        h4 = hx
        print(h4.shape)
        ...
        ## -------------Bridge-------------
        hx = self.relubg_1(self.bnbg_1(self.convbg_1(hx))) # 8
        ...
        hx = self.relu6d_1(self.bn6d_1(self.conv6d_1(torch.cat((hx,h6),1))))
        print(hx.shape)
        print(h6.shape)
        hx = self.relu6d_m(self.bn6d_m(self.conv6d_m(hx)))
        hx = self.relu6d_2(self.bn6d_2(self.conv6d_2(hx)))
        hd6 = hx

        hx = self.upscore2(hx) # 8 -> 16

        hx = self.relu5d_1(self.bn5d_1(self.conv5d_1(torch.cat((hx,h5),1))))
        hx = self.relu5d_m(self.bn5d_m(self.conv5d_m(hx)))
        hx = self.relu5d_2(self.bn5d_2(self.conv5d_2(hx)))
        hd5 = hx

        hx = self.upscore2(hx) # 16 -> 32

        hx = self.relu4d_1(self.bn4d_1(self.conv4d_1(torch.cat((hx,h4),1))))
        hx = self.relu4d_m(self.bn4d_m(self.conv4d_m(hx)))
        hx = self.relu4d_2(self.bn4d_2(self.conv4d_2(hx)))
        hd4 = hx

        hx = self.upscore2(hx) # 32 -> 64

        hx = self.relu3d_1(self.bn3d_1(self.conv3d_1(torch.cat((hx,h3),1))))
        hx = self.relu3d_m(self.bn3d_m(self.conv3d_m(hx)))
        hx = self.relu3d_2(self.bn3d_2(self.conv3d_2(hx)))
        hd3 = hx

        hx = self.upscore2(hx) # 64 -> 128

        hx = self.relu2d_1(self.bn2d_1(self.conv2d_1(torch.cat((hx,h2),1))))
        hx = self.relu2d_m(self.bn2d_m(self.conv2d_m(hx)))
        hx = self.relu2d_2(self.bn2d_2(self.conv2d_2(hx)))
        hd2 = hx

        hx = self.upscore2(hx) # 128 -> 256

        hx = self.relu1d_1(self.bn1d_1(self.conv1d_1(torch.cat((hx,h1),1))))
        hx = self.relu1d_m(self.bn1d_m(self.conv1d_m(hx)))
        hx = self.relu1d_2(self.bn1d_2(self.conv1d_2(hx)))
        hd1 = hx
        ...
        hx = self.outconv1(hx) # 256
        d1 = hx

        ## -------------Refine Module-------------
        hx = self.refunet(hx) # 256
        dout = hx
...
if __name__ == "__main__":
    ...
    model = models.resnet34().layer1.cuda()
